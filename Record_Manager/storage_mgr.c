...
**/
 RC readCurrentBlock (SM_FileHandle *fHandle, SM_PageHandle memPage){ 
	...
	int currentBlock ;
	int currentCursorPosition = 0;    	 //Eg.,CursorPosition(Block Number) = 300(0),4096(1),5000(1)8012(2)
...
**/
 RC readNextBlock (SM_FileHandle *fHandle, SM_PageHandle memPage){ 
	...
	int nextBlock ;
	int currentCursorPosition = 0;    	 //Eg.,CursorPosition(Block Number) = 300(1),4096(2),5000(2)8012(3)
